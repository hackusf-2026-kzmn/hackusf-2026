...
const translations = {
  en: {
    ...
    nwsFema: "NWS WEATHER ALERTS + CENSUS DATA",
    ...
    agents: [
      { name: "Scout Agent", description: "Monitors NWS weather alerts across Florida for severe weather, hurricanes, tropical storms, and flood warnings in real time." },
      { name: "Triage Agent", description: "Scores severity via Gemini AI using alert category, population density from Census data, and regional threat context." },
      { name: "Resource Agent", description: "Matches nearby emergency shelters and assistance resources to affected areas by proximity and capacity." },
      { name: "Comms Agent", description: "Drafts and delivers multilingual email alerts via Mailgun to opted-in community members." },
  ...
  es: {
    ...
    nwsFema: "ALERTAS METEOROLÓGICAS NWS + DATOS DEL CENSO",
    ...
    agents: [
      { name: "Agente Scout", description: "Monitorea alertas meteorológicas NWS en toda Florida para clima severo, huracanes, tormentas tropicales y avisos de inundación en tiempo real." },
      { name: "Agente Triage", description: "Puntúa la severidad vía Gemini AI usando categoría de alerta, densidad poblacional del Censo y contexto de amenaza regional." },
      { name: "Agente Resource", description: "Asocia refugios de emergencia y recursos de asistencia cercanos a las áreas afectadas por proximidad y capacidad." },
      { name: "Agente Comms", description: "Redacta y envía alertas multilingüe por correo vía Mailgun a miembros de la comunidad suscritos." },
